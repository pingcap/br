...
export GO_FAILPOINTS='github.com/pingcap/br/pkg/lightning/restore/FailAfterWriteRows=panic'
...
export GO_FAILPOINTS='github.com/pingcap/br/pkg/lightning/restore/FailAfterWriteRows=1*return->panic'
