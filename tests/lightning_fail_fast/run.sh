...
export GO_FAILPOINTS='github.com/pingcap/br/pkg/lightning/restore/SlowDownWriteRows=return(50);github.com/pingcap/br/pkg/lightning/restore/SetMinDeliverBytes=return(1)'
