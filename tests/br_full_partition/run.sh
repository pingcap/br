...
set -eu
DB="$TEST_NAME"
TABLE="partition_basic"
DB_COUNT=1

for i in $(seq $DB_COUNT); do
    run_sql "CREATE DATABASE $DB${i};"
    run_sql "USE $DB${i}; CREATE TABLE $TABLE (id int(11), unique index(id)) PARTITION BY RANGE COLUMNS ( id ) ( PARTITION p0 VALUES LESS THAN (6), PARTITION p1 VALUES LESS THAN (11), PARTITION p2 VALUES LESS THAN (16), PARTITION p3 VALUES LESS THAN (21) )"
    run_sql "USE $DB${i}; INSERT INTO $TABLE VALUES(7);"
    run_sql "USE $DB${i}; INSERT INTO $TABLE VALUES(12);"
    run_sql "USE $DB${i}; INSERT INTO $TABLE VALUES(16);"
done
