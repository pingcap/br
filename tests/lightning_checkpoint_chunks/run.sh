...
verify_checkpoint_noop() {
    ...
    run_sql 'SELECT count(*) FROM `tidb_lightning_checkpoint_test_cpch.1234567890.bak`.table_v6 WHERE status >= 200'
...
TASKID_FAILPOINTS="github.com/pingcap/br/pkg/lightning/lightning/SetTaskID=return(1234567890)"
export GO_FAILPOINTS="$TASKID_FAILPOINTS;github.com/pingcap/br/pkg/lightning/lightning/restore/FailIfImportedChunk=return($ROW_COUNT)"
...
export GO_FAILPOINTS="$TASKID_FAILPOINTS;github.com/pingcap/br/pkg/lightning/lightning/restore/KillIfImportedChunk=return($ROW_COUNT)"
