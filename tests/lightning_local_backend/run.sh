...
export GO_FAILPOINTS='github.com/pingcap/br/pkg/lightning/backend/FailIngestMeta=1*return("notleader")'
...
export GO_FAILPOINTS='github.com/pingcap/br/pkg/lightning/backend/FailIngestMeta=2*return("epochnotmatch")'
