...
const resetTSURL = "/pd/api/v1/admin/reset-ts"
const resetTsRetryTime = 16
const resetTSWaitInterval = 50 * time.Millisecond
const resetTSMaxWaitInterval = 500 * time.Millisecond
