...
export GO_FAILPOINTS="github.com/pingcap/br/pkg/lightning/lightning/SetTaskID=return(1234567890);github.com/pingcap/br/pkg/lightning/lightning/restore/FailIfImportedChunk=return(28)"
