...
// Source: github.com/pingcap/br/pkg/lightning/backend (interfaces: AbstractBackend,EngineWriter)
...
=======
// $ mockgen -package mock -mock_names 'AbstractBackend=MockBackend' github.com/pingcap/br/pkg/lightning/backend AbstractBackend,EngineWriter
>>>>>>> 2652f252... lightning: refactor the `backend` package (#877):pkg/mock/backend.go
